...
<div class="container">
    ...
    <h4 class="fw-bold py-3 mb-4">
      ...
      <div class="col-md-12 col-lg-12">
        <div class="row">
          <div class="col-lg-2 mb-4">
            <div class="card">
                <a href="{{ url('superadmin/tickets') }}" style="text-decoration: none;color: black;">
              <div class="card-body">
          ...
          <div class="col-lg-2 mb-4">
            <div class="card">
                <a href="{{ url('superadmin/open-tickets') }}" style="text-decoration: none;color: black;">
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  <div class="avatar flex-shrink-0">
                    <img src="../../assets/img/icons/unicons/wallet-info.png" alt="Credit Card" class="rounded">
      ...
      <hr>
      <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Tickets Open After 8 Hours</span>
      </h4>
        ...
        <div class="col-md-12 col-lg-12">
          <div class="row">
            <div class="col-lg-2 mb-4">
              <div class="card">
                <a href="{{ url('home/open-tickets-hours') }}" style="text-decoration: none;color: black;">
                <div class="card-body">
                  <div class="card-title d-flex align-items-start justify-content-between">
                    <div class="avatar flex-shrink-0">
                      <img src="../../assets/img/icons/unicons/wallet-info.png" alt="Credit Card" class="rounded">
                  ...
                  <span class="d-block">Open Tickets</span>
                  <h4 class="card-title mb-1">{{ count($hours) }}</h4>
                </div>
                </a>
              </div>
            </div>
